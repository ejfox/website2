...
const GEAR_ITEMS = [
  ...
  {
    Name: 'Small Watercolor Notebook',
    Weight_oz: 6,
    Type: 'Creativity',
    Category: 'Creative',
    Priority: 'High',
...
const RELATED_POSTS = [
  {
    post: {
      ...
      title: 'Threads',
      date: '2025-11-02',
      metadata: { title: 'Threads' },
    },
    overlappingTags: ['d3', 'canvas'],
  },
  {
    post: {
      slug: 'the-gear-system',
      title: 'The Gear System',
      date: '2026-06-18',
      metadata: { title: 'The Gear System' },
    },
    overlappingTags: ['gear'],
  },
]
const TOC_CHILDREN = [
...
const GH_EVENTS = [
  {
    occurredAt: '2026-06-22T14:10:00Z',
    message: 'fix(health): repair stats aggregation + surface sleep',
    repository: 'website2',
    type: 'PushEvent',
  },
  {
    occurredAt: '2026-06-21T19:00:00Z',
    message: 'copy: de-robotize taglines + clean og descriptions',
    repository: 'website2',
    type: 'PushEvent',
  },
  {
    occurredAt: '2026-06-20T11:30:00Z',
    message: 'feat: mirror blog posts into AT-Proto / standard.site',
    repository: 'website2',
    type: 'PushEvent',
  },
  {
    occurredAt: '2026-06-19T16:45:00Z',
    message: "perf(reveal): don't hide above-the-fold content (fixes LCP)",
    repository: 'website2',
    type: 'PushEvent',
  },
  {
    occurredAt: '2026-06-18T10:20:00Z',
    message: 'feat: projects page image-first masonry overhaul',
    repository: 'website2',
    type: 'PushEvent',
  },
  {
    occurredAt: '2026-06-17T09:15:00Z',
    message: 'feat(gear): specimen plate + 3D gear card',
    repository: 'website2',
    type: 'PushEvent',
  },
]
...
const PREDICTION = {
  id: 'pred-2025-0042',
  statement:
    'A frontier lab ships a model with a 10M-token context window before 2027.',
  confidence: 65,
  deadline: '2026-12-31',
  status: 'pending',
  resolved: false,
...
const mkRepo = (o) => ({
  id: o.name,
  fork: false,
  stats: { stars: o.stars, forks: o.forks, commits: o.commits },
  ...o,
})
const REPOS = [
  mkRepo({
    ...
    commits: 612,
    diskUsage: 9722,
    createdAt: '2012-03-17T02:42:38Z',
    pushedAt: '2017-05-03T17:22:42Z',
    languages: { JavaScript: 142000, CSS: 18000, HTML: 9000 },
  }),
  mkRepo({
    name: 'sStory',
    language: 'CSS',
    ...
    commits: 184,
    diskUsage: 5033,
    createdAt: '2012-05-12T01:16:31Z',
    pushedAt: '2014-05-11T05:28:31Z',
    languages: { CSS: 53711, CoffeeScript: 9333, JavaScript: 1073 },
  }),
  mkRepo({
    name: 'bart',
    language: 'JavaScript',
    ...
    commits: 96,
    diskUsage: 30654,
    createdAt: '2013-08-03T22:20:05Z',
    pushedAt: '2017-05-03T17:21:43Z',
    languages: { JavaScript: 41000, HTML: 3000 },
  }),
  mkRepo({
    name: 'twitter-artbot',
    language: 'JavaScript',
    ...
    commits: 240,
    diskUsage: 8459,
    createdAt: '2017-06-11T20:47:18Z',
    pushedAt: '2022-12-09T04:48:59Z',
    languages: { JavaScript: 1107516, CoffeeScript: 297001, HTML: 1409 },
  }),
  mkRepo({
    name: 'website',
    language: 'JavaScript',
    ...
    commits: 1820,
    diskUsage: 215512,
    createdAt: '2018-05-12T03:01:13Z',
    pushedAt: '2024-11-23T00:09:54Z',
    languages: { JavaScript: 166462, Vue: 121990, TypeScript: 13460 },
  }),
  mkRepo({
    name: 'hand-midi-controller',
    language: 'Python',
    color: '#3572A5',
    stars: 4,
    forks: 1,
    commits: 88,
    diskUsage: 109,
    createdAt: '2025-07-26T18:58:06Z',
    pushedAt: '2026-01-11T04:21:37Z',
    languages: { Python: 148411, Shell: 1553 },
  }),
  mkRepo({
    name: 'ascii_webcam',
    language: 'Python',
    ...
    commits: 14,
    diskUsage: 12,
    createdAt: '2024-09-03T19:59:50Z',
    pushedAt: '2024-09-03T20:01:50Z',
    languages: { Python: 10363 },
  }),
  mkRepo({
    name: 'subway-builder-mods',
    language: 'JavaScript',
    color: '#f1e05a',
    stars: 5,
    forks: 1,
    commits: 47,
    diskUsage: 34,
    createdAt: '2025-12-17T00:02:45Z',
    pushedAt: '2026-01-30T17:21:45Z',
    languages: { JavaScript: 79695 },
  }),
]
...
const COMMITS = [
  {
    sha: 'b4ac7dd',
    repo: 'vulpes-theme-lab',
    message: 'Release v0.3.0 - MapLibre + Vulpes Monthly Theme Line',
    date: '2025-12-04T03:55:53Z',
    commit: {
      message: 'Release v0.3.0 - MapLibre + Vulpes Monthly Theme Line',
    },
  },
  {
    sha: 'f2070a9',
    repo: 'dotfiles',
    message: 'feat(mcp): add tmux control server with current pane detection',
    date: '2025-12-04T03:45:02Z',
    commit: { message: 'feat(mcp): add tmux control server' },
  },
  {
    sha: '28817a3',
    repo: 'website2',
    message: 'fix: resolve all production build issues',
    date: '2025-12-03T21:26:02Z',
    commit: { message: 'fix: resolve all production build issues' },
  },
  {
    sha: '571366b',
    repo: 'website2',
    message: 'perf: optimize CommitMatrix animation performance',
    date: '2025-12-03T20:07:37Z',
    commit: { message: 'perf: optimize CommitMatrix animation performance' },
  },
  {
    sha: '212af1d',
    repo: 'website2',
    message: 'feat: animate commit matrix with Perlin noise + boid flocking',
    date: '2025-12-03T20:02:28Z',
    commit: { message: 'feat: animate commit matrix' },
  },
  {
    sha: 'a38c889',
    repo: 'website2',
    message: 'feat(stats): add 7777px WebGL commit matrix art piece',
    date: '2025-12-03T19:58:09Z',
    commit: { message: 'feat(stats): WebGL commit matrix' },
  },
  {
    sha: '592426f',
    repo: 'website2',
    message: 'feat(seo): add comprehensive structured data and metadata',
    date: '2025-12-03T19:45:45Z',
    commit: { message: 'feat(seo): structured data' },
  },
  {
    sha: 'd19dfbf',
    repo: 'scrapbook-cli',
    message:
      'fix: switch YouTube enrichment to Gemini 2.5 Flash for speed/cost',
    date: '2025-12-03T19:57:55Z',
    commit: { message: 'fix: YouTube enrichment to Gemini 2.5 Flash' },
  },
  {
    sha: '6a8129e',
    repo: 'website2',
    message: 'feat(on-this-day): add last updated timestamp display',
    date: '2025-12-03T19:48:09Z',
    commit: { message: 'feat(on-this-day): last updated timestamp' },
  },
  {
    sha: 'eade513',
    repo: 'dotfiles',
    message:
      'feat(nvim): workflow improvements, hardtime training, auto-validation',
    date: '2025-12-03T23:38:33Z',
    commit: { message: 'feat(nvim): workflow improvements' },
  },
]
...
const MATRIX_COMMITS = Array.from({ length: 280 }, (_, i) => {
  ...
  return {
    sha: `c${1000 + i}`,
    repo: MATRIX_REPOS[i % MATRIX_REPOS.length],
    message: `commit ${i}`,
    date,
...
export const stories = {
  ...
  BlogSparkline: [
    ...
    {
      name: 'grid',
      props: { value: 6, max: 12, type: 'grid', metric: 'images', columns: 6 },
    },
  ],
  PasswordGate: [
    {
  ...
  PostFooter: [
    {
      ...
      props: {
        prevPost: {
          slug: 'projects/MorningRadio',
          title: 'MorningRadio',
          date: '2025-08-10',
        },
        nextPost: {
          slug: '2025/using-radios',
          title: 'How To Use Radios',
          date: '2025-11-08',
        },
  ...
  PostTOC: [
    {
      name: 'default',
      props: { tocChildren: TOC_CHILDREN, activeSection: 'method' },
    },
  ],
  PostMetadata: [
    {
  ...
  ReplyContext: [
    {
      ...
      props: {
        replyTo:
          'https://gothamist.com/news/mapping-clusters-nypd-officers-repeatedly-accused-misconduct',
      },
    },
  ],
  ReplyContextItem: [
      ...
      props: {
        ...
        mock: [
          ...
          },
          {
            ...
            author: { name: 'Matt Webb', url: 'https://interconnected.org' },
          },
          {
            'wm-id': 4,
            'wm-property': 'in-reply-to',
            url: 'https://tomcritchlow.com/reply',
            author: { name: 'Tom Critchlow', url: 'https://tomcritchlow.com' },
            content: {
              text: 'The Parquet-in-the-browser trick is clever — stealing this for my own archive.',
            },
            published: '2025-03-10T14:22:00Z',
          },
          {
            'wm-id': 5,
            'wm-property': 'in-reply-to',
            url: 'https://robinsloan.com/reply',
            author: { name: 'Robin Sloan', url: 'https://robinsloan.com' },
            content: {
              text: 'Love seeing the whole pipeline laid out like this.',
            },
            published: '2025-03-11T09:05:00Z',
          },
        ],
      },
    },
  ...
  NextAvailableSlot: [
    {
      ...
      props: {
        mock: {
          slots: [
            {
              naturalTime: 'Tuesday at 2:30pm',
              bookingUrl: 'https://cal.com/ejfox/30min',
            },
          ],
        },
      },
  ...
  GearItem: [
    {
      name: 'metric',
      props: { item: GEAR_ITEM, weightUnit: 'metric' },
      wrapper: 'table',
    },
    {
      name: 'imperial',
      props: { item: GEAR_ITEM, weightUnit: 'imperial' },
      wrapper: 'table',
    },
  ],
  GearModelViewer: [
  ...
  GearCardInline: [
    { name: 'default', props: { gearSlug: 'wlf-enduro-pack-vest' } },
  ],
  ...
  HandDrawn: [
    {
      name: 'circled-3',
      props: { name: 'circled-3', size: '3rem', title: 'three' },
    },
  ...
  HandDrawnMark: [
    {
      name: 'around',
      props: { placement: 'around', tone: '#fde047' },
      slot: 'highlighted phrase',
    },
    {
      name: 'under',
      props: { placement: 'under', tone: '#f43f5e' },
      slot: 'underlined',
    },
  ],
  HandDrawnUnitChart: [
  ...
  GitHubParallelCoords: [
    { name: 'default', props: { repos: REPOS, width: 720, height: 360 } },
  ],
  GitHubRadialTimeline: [
    { name: 'default', props: { repos: REPOS, size: 520 } },
  ],
  GithubRepoCard: [
    {
      name: 'default',
      props: {
        name: 'website2',
        description: 'Personal website + publishing system built with Nuxt 3.',
        language: 'Vue',
        stars: 128,
        forks: 14,
      },
  ...
  LanguageBar: [
    {
      name: 'labels',
      props: {
        languages: { Vue: 52, TypeScript: 28, JavaScript: 14, CSS: 6 },
        height: 6,
        showLabels: true,
      },
    },
  ...
  SitemapLink: [
    {
      ...
      props: {
        to: '/gear',
        title: 'Gear',
        description: 'CSV-based inventory with weight calculations',
        external: false,
      },
    },
    {
          ...
          currentlyReading: [
            {
              ...
              numPages: 256,
              imageUrl:
                'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1755719567l/234802898._SX98_.jpg',
              goodreadsUrl: 'https://www.goodreads.com/review/show/8633279281',
            },
            {
              id: '204927599',
              ...
              numPages: 528,
              imageUrl:
                'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1709986452l/204927599._SX98_.jpg',
              goodreadsUrl: 'https://www.goodreads.com/review/show/7755658751',
            },
          ],
          recentlyRead: [
            {
              ...
              numPages: 256,
              imageUrl: '',
              goodreadsUrl: 'https://www.goodreads.com/review/show/8591777368',
            },
            {
              id: '25387807',
              ...
              numPages: 256,
              imageUrl: '',
              goodreadsUrl: 'https://www.goodreads.com/review/show/8477820792',
            },
          ],
        },
      },
      ...
      props: {
        stats: {
          ...
          recentTracks: {
            tracks: [
              {
                name: 'The World is Still',
                artist: { name: 'Bill Callahan' },
                playcount: 1,
                date: { uts: 1782069184 },
              },
              {
            ...
            topRatedFilms: [
              {
                ...
                isRewatch: false,
                letterboxdUrl:
                  'https://letterboxd.com/ejfox/film/poor-things-2023/',
              },
              {
                title: 'The Fall Guy',
                slug: 'the-fall-guy-2024',
                rating: 4,
                watchedDate: '2026-03-21',
                isRewatch: false,
                letterboxdUrl:
                  'https://letterboxd.com/ejfox/film/the-fall-guy-2024/',
              },
            ],
          },
        },
      ...
      props: {
        stats: {
          rescueTime: {
            week: {
              summary: {
                total: { hoursDecimal: 38.4 },
                productive: { percentage: 72 },
                distracting: { percentage: 14 },
              },
            },
            month: {
              summary: {
                total: { hoursDecimal: 162 },
                productive: { percentage: 70 },
                distracting: { percentage: 16 },
              },
            },
          },
        },
  ...
  StatsDataState: [
    {
      name: 'unavailable',
      props: { message: 'No data available', type: 'unavailable' },
    },
  ...
  AnimatedNumber: [
    {
      name: 'commas',
      props: { value: 1284302, format: 'commas', class: 'text-3xl font-light' },
    },
    {
      name: 'currency',
      props: { value: 4200, format: 'currency', class: 'text-3xl font-light' },
    },
    {
      name: 'percent',
      props: {
  ...
  SparklineScaled: [
    {
      name: 'squares',
      props: { values: SPARK, type: 'squares', width: 120, height: 24 },
    },
    {
      name: 'line',
      props: {
  ...
  StaticContent: [
    {
      name: 'default',
      props: {
        html: '<p class="prose">Server-rendered static HTML content.</p>',
      },
    },
  ],
  SupportLinks: [
  ...
  RhythmicSparklines: [
    {
      name: 'header',
      props: { data: SPARK, variant: 'header', baseline: 3, showPeak: true },
    },
    {
      name: 'inline',
      props: { data: SPARK, variant: 'inline', showPeak: false },
    },
  ],
  ...
  PullQuote: [
    {
      name: 'left',
      props: {
        text: 'When the system hangs, delete code until it works.',
        align: 'left',
      },
    },
    {
      name: 'center',
      props: {
        text: 'Simple beats complex. Working beats perfect.',
        align: 'center',
      },
    },
  ],
  ScrollIndicator: [
    { name: 'default', props: { color: 'rgba(120,120,120,0.4)' } },
  ],
}
