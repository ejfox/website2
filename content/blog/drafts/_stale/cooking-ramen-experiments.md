...
modified: 2025-08-30T11:02:54-04:00
hidden: true
tags:
  - food
  - recipe
...
I had a brief obsession with the raw egg technique—crack a yolk into the bowl, then pour the hot noodles and just a bit of that starchy cooking water over it, stirring fast until the egg coats the noodles.

Then there are my ongoing experiments with buldak—those Korean fire noodles that are basically nuclear if you use the whole packet. I've learned to use maybe a third at most, then build complexity with other ingredients.
