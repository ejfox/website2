...
![AI coaching platform interface displaying user conversation memories about sports management decisions, with incoming messages, processing logs, and memory storage for dialogue analysis.](http://res.cloudinary.com/ejf/image/upload/v1716768321/Screenshot_2024-05-26_at_8.05.09_PM.png)
...
```shell
cd ~/whisper.cpp
for file in ~/Downloads/FieldTalk/*.wav; do ./main -f "$file" -l en --output-vtt; done
```
