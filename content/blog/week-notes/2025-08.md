...
**Hexagram News:** Bought <http://web.archive.org/web/20250417034753/https://hexagram.news/ _[archived 2025-04-17]_> – picked some fonts out and got it pulling from a supabase table for the headlines. Need to work on automating the processes by which we add new headlines, but I'll save that for later.
