...
![Twitter posts joking about welcoming someone to a cult with absurd rules, then immediately clarifying the word choice.](http://res.cloudinary.com/ejf/image/upload/v1726593376/Screenshot_2024-09-17_at_1.16.03_PM.png)

![README documentation for markdown-tag-updater CLI tool that automatically adds relevant tags to markdown files using OpenRouter API.](http://res.cloudinary.com/ejf/image/upload/v1726780671/Screenshot_2024-09-19_at_5.17.38_PM.png)

![Terminal showing Fly.io machine updates for scrapbook-core app with DNS validation error due to invalid hostname characters.](http://res.cloudinary.com/ejf/image/upload/v1726785675/Screenshot_2024-09-19_at_6.41.01_PM.png)

![Developer comparing prompt engineering techniques for image description tasks in ChatGPT, with structured prompts and tag-generation methods displayed side-by-side.](http://res.cloudinary.com/ejf/image/upload/v1726791978/Screenshot_2024-09-19_at_8.26.03_PM.png)
...
![Multiple GitHub repository pages and code editor windows showing the Obsidian Media DB Plugin project files and documentation.](http://res.cloudinary.com/ejf/image/upload/v1726930224/Screenshot_2024-09-21_at_10.50.01_AM.png)

![A/B test results comparing two video thumbnails about converting bookmarks into knowledge graphs using local LLMs, with thumbnail 2 preferred at 52.9% watch time share.](http://res.cloudinary.com/ejf/image/upload/v1726930804/Screenshot_2024-09-21_at_10.59.52_AM.png)
