...
A minimal, friends-only "presence" app: broadcast your vibe with a single emoji — no chat, no feed, no metrics. Monochrome by design, built native on both platforms (SwiftUI + Jetpack Compose) over Supabase.
