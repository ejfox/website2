...
date: 2025-11-08T15:19:34-05:00
modified: 2025-11-08T15:22:13-05:00
tags:
  - communication
  - radio
  - tech
...
### Good vs Bad Comms: Lessons from Video Games
...
**Good radio:** Constant flow of useful information. "Enemy squad moving north through the trees… 200 meters from our position." "Copy that, I have eyes on them from overwatch." "Medic moving to your position, ETA 30 seconds." "Roger, holding position." "Movement at your 2 o'clock" "Got it, eyes on"
...
We actually see this proven out across multiple domains. Airsofters can simulate scenarios and get faster shot placement times with real guns, having never practiced with them before. FPV drone pilots spend 100+ hours in simulators before ever flying in real life.
...
Take, for example, the "over and out" phrase commonly used in radio communication. The phrase encapsulates the essence of radio communication—clarity, brevity, and finality—all in just three syllables. It's a linguistic meme that has stood the test of time, rounded down like a river rock over time.
...
The universality of radio is about the human instinct for efficient communication. Interestingly, this culture of coded language has found a new home in the digital age. Platforms like Discord, popular among younger generations, have become the modern-day equivalents of radio channels or the old party phone lines I'd call into as a bratty teenager. Here, users employ a blend of shorthand phrases, emojis, and voice chats to communicate with a level of efficiency that would make any seasoned radio operator proud.

### How to Actually Practice This

You can (if you feel so inclined) explore ham radio and its eccentric way of speaking in Morse or Q-codes, or study the machismo 10-codes of police, or dive into the abbreviation and jargon-heavy comms of the military. But I think the real practice comes from focusing on the moments in your life when critical communication actually matters, and intentionally working to better yourself in those moments.
...
- **Include as much context as necessary, in as few words as possible**: "Black bear, 30 meters northeast, moving away" not "I saw a bear"
- **Confirm receipt**: Wait for "copy" or "roger" before assuming the message got through, and repeat it if necessary
