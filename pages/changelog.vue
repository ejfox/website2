<template>
  <div class="max-w-screen-xl mx-auto px-4 md:px-8 xl:px-16 pt-8">
    <div class="max-w-4xl">
      ...
      <header class="mb-10">
        <h1
          class="font-mono text-sm uppercase tracking-widest text-zinc-900 dark:text-zinc-100 mb-2"
        >
          Changelog
        </h1>
        <p class="font-serif text-zinc-500 dark:text-zinc-400 text-base italic">
          This site is a living thing. It grows, breaks, gets rebuilt, and
          occasionally surprises me.
        </p>
        <div
        ...
        >
          ...
          <span v-if="manifestData">{{ manifestData.length }} posts</span>
      ...
      <section class="mb-12">
        <details>
          <summary
            class="font-mono text-xs text-zinc-500 dark:text-zinc-500 cursor-pointer hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors select-none"
          >
          ...
          <div v-if="commitData" class="mt-4">
            <!-- Stats -->
            <div
              class="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4 font-mono text-xs"
            >
              <div
            ...
            <div class="mt-8 text-center">
              <button
                v-if="canLoadMore"
                class="link-mono-hover font-mono text-xs text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100"
                @click="loadMore"
              >
                Load more commits
              </button>
