<template>
  <div class="p-4 lg:px-8">
    <img
      src="/images/handdrawn_ceramics_text/handdrawn_ceramics_text-24.svg" class="w-8 md:w-12 h-auto
    mx-auto
    absolute
    z-50
    top-2
    ...
    <img
      src="/images/handdrawn_ceramics_text/handdrawn_ceramics_text-26.svg"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-2 md:gap-4 lg:gap-6 xl:gap-8 my-8">
      <div
        v-for="product in products" v-show="product.metadata.sold !== 'true'" :key="product.id"
        class="p-2 max-w-screen-md "
      >
    ...
    <img
      :src="`/images/handdrawn_ceramics_text/handdrawn_ceramics_text-09.svg`"
