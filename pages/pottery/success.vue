<template>
  <div>
    <h1 class="text-4xl text-center leading-0 my-8">
      Thank you so much for your purchase!
    </h1>

    <div class="flex flex-row justify-evenly items-center">
      <img
        src="/images/handdrawn_ceramics_text/handdrawn_ceramics_text-07.svg"
        class="mt-4 w-64 mx-auto h-auto dark:invert"
      />

      <img
        src="/images/handdrawn_ceramics_text/handdrawn_ceramics_text-06.svg"
