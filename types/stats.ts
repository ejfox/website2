// Shape of the aggregated /api/stats response (built in server/api/stats.get.ts).
// Extracted from useStats.ts — the big response types live here; the composable
// (logic) stays in composables/useStats.ts.
