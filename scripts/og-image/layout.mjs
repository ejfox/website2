...
export function layoutCards(slug, content) {
  ...
  cards.push({
    type: 'title',
    text: content.title,
    x: camOffsetX + randRange(rng, -60, 60),
    y: camOffsetY + randRange(rng, -40, 20),
    z: randRange(rng, 0.1, 0.3),
    width: 700,
    height: 140,
