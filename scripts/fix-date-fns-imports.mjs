...
console.log(chalk.blue.bold('🔧 Fixing date-fns imports for better tree-shaking...'))
...
console.log(chalk.dim('All date-fns imports now use centralized utils for better tree-shaking'))
